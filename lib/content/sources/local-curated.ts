...
export const CURATED_STORIES: readonly RawStory[] = [
...

  {
    ...
    priority: 90,
    chipLabel: "Charli XCX surprise album",
  ...
  },
  {
    ...
    category: "pop_culture",
    priority: 75,
    chipLabel: "Sabrina Carpenter tour record",
  ...
  },
  {
    ...
    category: "finance",
    priority: 78,
    chipLabel: "S&P 500 biggest rally",
...

  {
    ...
    category: "tech",
    priority: 95,
    chipLabel: "GPT-5 launches today",
...

  {
    ...
    category: "general",
    priority: 88,
    chipLabel: "Binding climate deal",
  ...
  },
  {
    ...
    category: "general",
    priority: 72,
    chipLabel: "WHO ends mpox emergency",
  ...
  },
  {
    ...
    category: "world",
    priority: 70,
    chipLabel: "Japan's $50B Asia push",
